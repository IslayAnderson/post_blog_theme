...
function bones_related_posts() {
	...
	if($tags) {
		...
		if($related_posts) {
			...
			<?php echo '<li class="no_related_post">' . __( 'No Related Posts Yet!', 'gdstheme' ) . '</li>'; ?>
		<?php }
	}
	wp_reset_postdata();
	echo '</ul>';
...
function bones_register_sidebars() {
	...
	register_sidebar(array(
		'id' => 'sidebar2',
		'name' => __( 'Sidebar 2', 'gdstheme' ),
		'description' => __( 'The second (secondary) sidebar.', 'gdstheme' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h4 class="widgettitle">',
		'after_title' => '</h4>',
    ...
    <article  class="cf">
      <header class="comment-author vcard">
        ...
        */
        ...
        <?php printf(__( '<cite class="fn">%1$s</cite> %2$s', 'gdstheme' ), get_comment_author_link(), edit_comment_link(__( '(Edit)', 'gdstheme' ),'  ','') ) ?>
      ...
      <?php if ($comment->comment_approved == '0') : ?>
        <div class="alert alert-info">
          <p><?php _e( 'Your comment is awaiting moderation.', 'gdstheme' ) ?></p>
        </div>
      <?php endif; ?>
